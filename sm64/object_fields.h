...
#define OBJECT_FIELD_TRIPLET(index)       (*(triplet*)(&rawData.asF32[index]))
#if !IS_64_BIT
...
#define /*0x0A0*/ oPos                        OBJECT_FIELD_TRIPLET(O_POS_INDEX)
...
#define /*0x0AC*/ oVel                        OBJECT_FIELD_TRIPLET(0x09)
...
#define /*0x164*/ oHome                       OBJECT_FIELD_TRIPLET(0x37)
